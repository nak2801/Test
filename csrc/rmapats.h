...
extern "C" {
#endif
void  rmaPropagate0_simv_winbond_daidir (UB  * pcode, vec32  * I1125, U  I996);
void  rmaPropagate1_p_simv_winbond_daidir (UB  * pcode, vec32  * I1125, U  I996);
void  rmaPropagate1_simv_winbond_daidir (UB  * pcode, vec32  * I1125, U  I996);
void  rmaPropagate1_t0_simv_winbond_daidir (UB  * pcode, U  I996);
void  rmaPropagate2_p_simv_winbond_daidir (UB  * pcode, vec32  * I1125, U  I996);
void  rmaPropagate2_simv_winbond_daidir (UB  * pcode, vec32  * I1125, U  I996);
void  rmaPropagate2_t0_simv_winbond_daidir (UB  * pcode, U  I996);
void  rmaPropagate3_simv_winbond_daidir (UB  * pcode, scalar  val);
void  rmaPropagate3_t0_simv_winbond_daidir (UB  * pcode, UB  val);
void  rmaPropagate4_simv_winbond_daidir (UB  * pcode, scalar  val);
void  rmaPropagate5_simv_winbond_daidir (UB  * pcode, scalar  val);
void  rmaPropagate5_s0_simv_winbond_daidir (UB  * pcode, scalar  val);
void  rmaPropagate6_simv_winbond_daidir (UB  * pcode, scalar  val);
void  rmaPropagate6_s0_simv_winbond_daidir (UB  * pcode, scalar  val);
void  rmaPropagate7_simv_winbond_daidir (UB  * pcode, scalar  val);
void  rmaPropagate7_s0_simv_winbond_daidir (UB  * pcode, scalar  val);
void  rmaPropagate8_simv_winbond_daidir (UB  * pcode, scalar  val);
void  rmaPropagate9_simv_winbond_daidir (UB  * pcode, scalar  val);
